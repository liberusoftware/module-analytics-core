...
it('rejects duplicate and unknown analytics destinations', function (): void {
    ...
    expect($registry->get('test'))->toBe($destination)
        ...
        ->and(fn (): AnalyticsDestination => $registry->get('missing'))->toThrow(InvalidArgumentException::class);
});
